// ignore_for_file: avoid_print, depend_on_referenced_packages, camel_case_types, non_constant_identifier_names, prefer_typing_uninitialized_variables, unused_local_variable
...
class _Faq_ScreeenState extends State<Faq_Screeen> {
  ...
  Future FaqList() async {
    ...
    try{
      var response = await http.post(Uri.parse('${config().baseUrl2}/api/faq.php'), body: jsonEncode(body), headers: {
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      appBar: AppBar(
        ...
        title:  const Text('Faq List',style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold)),
      ),
