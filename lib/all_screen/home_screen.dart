        ...
        title: Row(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text('ProZigzagBus'.tr,style: TextStyle(color: notifier.theamcolorelight,fontSize: 20,fontFamily: 'SofiaProBold'),),
            ),
          ],
        ),
      ),
                                    ...
                                    child:  ElevatedButton(
                                        style: ButtonStyle(
                                          ...
                                          textStyle: MaterialStateProperty.all(
                                            TextStyle(color: selectcontain == 0 ? Colors.white : Colors.black),
                                          ),
                                          backgroundColor: MaterialStateProperty.all(
                                            selectcontain == 0 ? notifier.theamcolorelight : const Color(0xffD6C1F9),
                                          ),
