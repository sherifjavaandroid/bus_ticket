          ...
          data.busData.isEmpty ?  Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text('ProZigzagBus fulfilled buses are not available at this time.'.tr,textAlign: TextAlign.center,style: const TextStyle(fontSize: 16,color: Colors.grey ,fontFamily: 'SofiaProBold'),),
              ),
            ],
          ) : Expanded(
